...
export default function Post({ post }) {
  ...
  return (
    <section
      className={
        darkMode
          ? "flex flex-col xl:w-1/3 w-11/12 lg:w-2/3 bg-slate-400 border border-slate-600 justify-center items-center h-fit mt-10 rounded-md  lg:p-3 lg:m-10 shadow-lg"
